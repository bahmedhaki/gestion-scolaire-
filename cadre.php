...
<div id="monmenu" >
		<ul class="niveau1">
			<li><a href="1" class="fly">Etudiants </a>
				<ul class="niveau2" style="top : 4px;">
					<li><a href="listeEtudiant.php?list=true">Consulter la liste</a>
						<ul class="niveau3">
						<?php $retour=mysql_query("select distinct nom from classe");
			...
			<li><a href="#">Mati�re </a>
				<ul class="niveau2">
					<li><li><a href="#">Voir les mati�res</a>
						<ul class="niveau3">
							<?php	while($nomcl=mysql_fetch_array($data)){
								echo '<li><a href="afficher_matiere.php?nomcl='.$nomcl['nom'].'">'.$nomcl['nom'].'</a></li>';
								}
					echo '</ul>
					</li>';
				if(isset($_SESSION['admin'])){ echo '<li><li><a href="ajout_matiere.php">Ajouter une mati�re</a></li>'; }
				echo '</ul>
			</li>';
			...
			echo '<li><a href="#">Dipl�mes</a>
				<ul class="niveau2">
					<li><a href="type_diplome.php">Types de dipl�mes</a></li>';
					 if(isset($_SESSION['admin']) or isset($_SESSION['prof']))
					echo '<li><a href="diplome_obt.php">Dipl�mes obtenus</a></li>	';
					if(isset($_SESSION['admin']))
