<?php  
 ...
 $query = "SELECT * FROM prof ORDER BY id DESC";  
 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="width:700px;">  
                <h3 align="center">Liste des ensingantes</h3>  
                <br />  
                     ...
                     <div id="employee_table">  
                          <table class="table table-bordered">  
                               ...
                               <tr>  
                                    ...
                                    <td><a href ="supprimerprof.php ?id=<?php echo($row['id'])  ?>"> Supprimer </a> </td> 
                               </tr>  
                               <?php  
                               }  
                               ?>  
           ...
           <div class="modal-content">  
                ...
                <div class="modal-body">  
                     <form method="post" id="insert_form">  
                          ...
                          <br />  
                          <label>Enter Employee prenom</label>  
