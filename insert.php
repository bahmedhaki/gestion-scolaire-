<?php  
 ...
 {  
      ...
      {  
           $query = "  
           INSERT INTO etudiant(nom, prenom, sex, telephone, address, photo, date_de_naissance, code_class)  
           VALUES('$nom', '$prenom', '$sex', '$telephone', '$address', '', '2018-04-06', '1')
           ";  
      ...
      {  
           ...
           $select_query = "SELECT * FROM etudiant ORDER BY id DESC";  
           ...
           {  
                $output .= '  
                     <tr>  
                          ...
                          <td><a href ="supprimeretudiant.php ?id="' .$row['id'] . '""> Supprimer </a> </td>
                     </tr>  
                ';  
           }  
           $output .= '</table>';  
